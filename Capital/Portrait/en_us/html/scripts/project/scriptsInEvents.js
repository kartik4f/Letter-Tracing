...
const scriptsInEvents = {
	...
	async Es_common_Event11_Act1(runtime, localVars)
	{
	...
	async Es_analytics_Event4_Act1(runtime, localVars)
	{
		...
		let href = runtime.globalVars.UNIWEBVIEW_SCHEMA +"://CallSkidosAPI?subject="+localVars.subject+"&sub_subject="+localVars.sub_subject+"&character="+localVars.character;
		console.log("href = "+href);
		if(runtime.globalVars.IS_ANALYTICS)
		window.location.href = href;
	...
	async Es_analytics_Event5_Act1(runtime, localVars)
	{
	...
	async Es_analytics_Event13_Act1(runtime, localVars)
	{
	...
	async Es_alphabetselectionsmall_Event1_Act5(runtime, localVars)
	{
		let jsonData = runtime.objects.JsonEntryData.getFirstInstance().getJsonDataCopy();
